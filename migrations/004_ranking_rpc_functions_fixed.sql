-- ============================================
-- Ranking RPC Functions for Performance Optimization (FIXED)
-- Created: 2026-01-11
-- Fixed: Type mismatch error (VARCHAR → TEXT casting)
-- ============================================
...
-- ============================================
-- Function 1: POW Time Rankings (수정됨)
-- ============================================
...
BEGIN
  ...
  WITH user_stats AS (
    SELECT
      u.discord_id,
      u.discord_username::TEXT,  -- VARCHAR → TEXT 캐스팅
      u.discord_avatar::TEXT,    -- VARCHAR → TEXT 캐스팅
...
-- ============================================
-- Function 2: Donation Rankings (수정됨)
-- ============================================
